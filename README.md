...
[![CI](https://github.com/jonzeolla/triss25/actions/workflows/commit.yml/badge.svg)](https://github.com/jonzeolla/triss25/actions/workflows/commit.yml)
...
# Run the image
docker run jonzeolla/triss25:0.0.0 --help
```
